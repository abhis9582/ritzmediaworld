...
<html lang="en">
        ...
        <section class="wrapper">            
            ...
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><i class="fa fa-laptop"></i>Add New Testimonial</li>						  	
                </ol>
            </div>
        </div>
        <div class="row">
  ...
  ?>
                <form class="form-horizontal" action="<?=BASE_URL.'admin/home/add_testimonial'?>" method="post" enctype="multipart/form-data">
                <input id="SaveStatus" name="submitF" type="hidden" value="1" />
                    ...
                    <div class="form-group">
                            <div class="col-md-offset-4 col-md-4" >
                                ...
                                <button class="btn btn-default" onclick="window.location.href='<?=BASE_URL?>admin/testimonials'"  type="button">Cancel</button>
                            </div>
                        </div>
