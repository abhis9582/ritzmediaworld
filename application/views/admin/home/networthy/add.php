...
<html lang="en">
  ...
  <section id="container" class="">
    ...
    <section id="main-content">
        <section class="wrapper">            
            ...
            <div class="row">
            <div class="col-lg-12">
                <h3 class="page-header"><i class="fa fa-laptop"></i> Add Data</h3>
                <ol class="breadcrumb">
                    <li><i class="fa fa-home"></i><a href="<?=BASE_URL?>admin/dashboard">Home</a></li>
                    <li><i class="fa fa-laptop"></i>Add New Data</li>						  	
                </ol>
            </div>
        </div>
        <div class="row">
  ...
  ?>
                <form class="form-horizontal" action="<?=BASE_URL.'admin/home/add_networthy_assets'?>" method="post" enctype="multipart/form-data">
                <input id="SaveStatus" name="submitF" type="hidden" value="1" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="file" name="n_image" id="n_image" class="form-control" required>
                        </div>
                    </div>
                    <div class="form-group">
                            <div class="col-md-offset-4 col-md-4" >
                                <button class="btn btn-primary admin-buttns2" name="submitForm" type="submit">Submit</button>
                                <button class="btn btn-default" onclick="window.location.href='<?=BASE_URL?>admin/networthy_assets'"  type="button">Cancel</button>
                            </div>
                        </div>
