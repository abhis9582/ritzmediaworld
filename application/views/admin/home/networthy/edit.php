...
<html lang="en">
     ...
     <?php $this->load->view("Element/admin/header.php");?>
      ...
      <section id="main-content">
          <section class="wrapper">            
			  ...
			  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-laptop"></i> Edit Data</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="<?=BASE_URL?>admin/dashboard">Home</a></li>
						<li><i class="fa fa-laptop"></i> <a href="<?=BASE_URL?>admin/networthy_assets">Networthy Assets</a></li>						  	
					</ol>
				</div>
			</div>
            <div class="row">
                <div class="col-lg-12">
                    <section class="panel">
                        <header class="panel-heading">
                            Edit Data<br>
                            <a style="float:right;margin-bottom:10px;" class="btn btn-primary admin-buttns" href="<?=BASE_URL?>admin/home/networthy" title="Back">Back</a>
                        </header>
  ...
  ?> 
                <form class="form-horizontal" action="<?=BASE_URL.'admin/home/edit_networthy_assets/'.$n_Data[0]['id'];?>" method="post" enctype="multipart/form-data">
                <input id="SaveStatus" name="submitF" type="hidden" value="1" />
                <input id="id" name="id" type="hidden" value="<?=$n_Data[0]['id']?>" />
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Title</label>
                        <div class="col-sm-6">
                            <input type="text" name="title" id="titile" value="<?=(isset($n_Data[0]['title'])!='')?$n_Data[0]['title']:''?>" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Image</label>
                        <div class="col-sm-6">
                            <input type="file" name="n_image" id="n_image" class="form-control">
                            <?php 
                            $imagename=$n_Data[0]['n_image'];
                            $imgpath=$this->image->GetImageDirectory('networthy',$imagename);
