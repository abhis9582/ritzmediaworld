...
<html lang="en">
  ...
  <section id="container" class="">
    ...
    <section id="main-content">
        <section class="wrapper">            
            ...
            <div class="row">
            <div class="col-lg-12">
                <h3 class="page-header"><i class="fa fa-laptop"></i> Add Service</h3>
                <ol class="breadcrumb">
                    <li><i class="fa fa-home"></i><a href="<?=BASE_URL?>admin/dashboard">Home</a></li>
                    <li><i class="fa fa-laptop"></i>Add New Service</li>						  	
                </ol>
            </div>
        </div>
        <div class="row">
  ...
  ?>
                <form class="form-horizontal" action="<?=BASE_URL.'admin/home/add_service'?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="file" name="service_image1" id="service_image1" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="col-md-offset-4 col-md-4" >
                            ...
                            <button class="btn btn-default" onclick="window.location.href='<?=BASE_URL?>admin/services'"  type="button">Cancel</button>
                        </div>
                    </div>
                </form>
                </div>
