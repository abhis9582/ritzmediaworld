...
<html lang="en">
			  ...
			  <div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						...
						<li><i class="fa fa-laptop"></i> <a href="<?=BASE_URL?>admin/kaam_hai_mera">Kaam Hai Mera</a></li>
					</ol>
				</div>
			</div>
            <div class="row">
                <div class="col-lg-12">
                    <section class="panel">
                        <header class="panel-heading">
                            Edit Data<br>
                            <a style="float:right;margin-bottom:10px;" class="btn btn-primary admin-buttns" href="<?=BASE_URL?>admin/home/kaam_hai_mera" title="Back">Back</a>
                        </header>
  ...
  ?> 
                <form class="form-horizontal" action="<?=BASE_URL.'admin/home/edit_khm/'.$khm_data[0]['id'];?>" method="post" enctype="multipart/form-data">
                <input id="SaveStatus" name="submitF" type="hidden" value="1" />
                <input id="id" name="id" type="hidden" value="<?=$khm_data[0]['id']?>" />
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Image </label>
                        <div class="col-sm-6">
                            <input type="file" name="khm_image" id="khm_image" class="form-control"> <br>
                            <?php 
                            $imagename=$khm_data[0]['khm_image'];
                            $imgpath=$this->image->GetImageDirectory('khm',$imagename);
