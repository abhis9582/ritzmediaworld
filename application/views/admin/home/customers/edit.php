...
<html lang="en">
     ...
     <?php $this->load->view("Element/admin/header.php");?>
      ...
      <section id="main-content">
          <section class="wrapper">            
			  ...
			  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-laptop"></i> Edit Customer</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="<?=BASE_URL?>admin/dashboard">Home</a></li>
						<li><i class="fa fa-laptop"></i> <a href="<?=BASE_URL?>admin/customers">Customers</a></li>						  	
					</ol>
				</div>
			</div>
            <div class="row">
                <div class="col-lg-12">
                    <section class="panel">
                        <header class="panel-heading">
                            Edit Customer<br>
                            <a style="float:right;margin-bottom:10px;" class="btn btn-primary admin-buttns" href="<?=BASE_URL?>admin/home/customers" title="Back">Back</a>
                        </header>
  ...
  ?> 
                <form class="form-horizontal" action="<?=BASE_URL.'admin/home/edit_customer/'.$CustomerData[0]['id'];?>" method="post" enctype="multipart/form-data">
                <input id="SaveStatus" name="submitF" type="hidden" value="1" />
                <input id="id" name="id" type="hidden" value="<?=$CustomerData[0]['id']?>" />
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Customer Image </label>
                        <div class="col-sm-6">
                            <input type="file" name="customer_image1" id="customer_image1" class="form-control"> <br>
                            <?php 
                            $imagename=$CustomerData[0]['customer_image'];
                            $imgpath=$this->image->GetImageDirectory('customers',$imagename);
                    ...
                    <div class="form-group">
                        <div class="col-md-offset-4 col-md-4" >
                            ...
                            <button onclick="window.location.href='<?=BASE_URL?>admin/home/customers'" class="btn btn-default" type="button">Cancel</button>
                        </div>
                    </div>
                </form>
                </div>
