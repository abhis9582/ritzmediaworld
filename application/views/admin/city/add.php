...
<html lang="en">
     ...
     <?php $this->load->view("Element/admin/header.php");?>
      ...
      <section id="main-content">
          <section class="wrapper">            
			  ...
			  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-laptop"></i> Add City</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="<?=BASE_URL?>admin/dashboard">Home</a></li>
						<li><i class="fa fa-laptop"></i>Add City</li>						  	
					</ol>
				</div>
			</div>
  ...
  ?>
                              <form class="form-horizontal" action="<?=BASE_URL.'admin/cities/add'?>" method="post" enctype="multipart/form-data">
							  <input id="SaveStatus" name="submitF" type="hidden" value="1" />
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-6">
                                          <input type="text" name="name" id="name" value=" <?=(isset($_POST['name'])!='')?$_POST['name']:''?>" class="form-control">
								    ...
								    <div class="form-group">
									 ...
									 <option value="1" <?=($_POST['status']==1)?'selected="selected"':''?> >Active</option>
									 <option value="0" <?=($_POST['status']==0)?'selected="selected"':''?>>In-active</option>
								  ...
								  <div class="form-group">
                                          <div class="col-md-offset-4 col-md-4" >
                                              ...
                                              <button class="btn btn-default" type="button" onclick="window.location.href='<?=BASE_URL?>admin/cities'">Cancel</button>
                                          </div>
                                      </div>
