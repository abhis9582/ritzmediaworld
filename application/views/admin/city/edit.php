...
<html lang="en">
     ...
     <?php $this->load->view("Element/admin/header.php");?>
      ...
      <section id="main-content">
          <section class="wrapper">            
			  ...
			  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-laptop"></i> Edit City</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="<?=BASE_URL?>admin/dashboard">Home</a></li>
						<li><i class="fa fa-laptop"></i> <a href="<?=BASE_URL?>admin/cities">Manage Cities</a></li>						  	
						<li><i class="fa fa-laptop"></i> <?=(isset($GalleryData[0]['name'])!='')?$GalleryData[0]['name']:''?></li>						  	
					</ol>
				</div>
			</div>
          <div class="row">
  ...
  ?>
                              <form class="form-horizontal" action="<?=BASE_URL.'admin/cities/edit/'.$GalleryData[0]['id'];?>" method="post" enctype="multipart/form-data">
							  ...
							  <input id="id" name="id" type="hidden" value="<?=$GalleryData[0]['id']?>" />
								  ...
								  <div class="form-group">
                                      ...
                                      <div class="col-sm-6">
										  ...
										  foreach($allState as $StateData){ 
										  
										  ?>
											 <option value="<?=$StateData['id']?>" <?=($StateData['id']==$GalleryData[0]['state_id'])?'selected':''?>> <?=$StateData['name']?></option> 
										 <?php 
										 }
										  ?>
										  </select>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-6">
                                          <input type="text" name="name" id="name" value="<?=(isset($GalleryData[0]['name'])!='')?$GalleryData[0]['name']:''?>" class="form-control">
                                      </div>
                                  </div>
								  ...
								  <div class="form-group">
                                        <div class="col-md-offset-4 col-md-4" >
                                              ...
                                              <button class="btn btn-default"  onclick="window.location.href='<?=BASE_URL?>admin/cities'" type="button">Cancel</button>
                                          </div>
                                      </div>
