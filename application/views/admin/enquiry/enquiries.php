  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-laptop"></i> Enquiries</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="<?= BASE_URL ?>admin/dashboard">Home</a></li>
              <li><i class="fa fa-laptop"></i>Manage Enquiries</li>
            </ol>
          </div>
        </div>
        <div class="row">
                  ...
                  <tbody>
                    <?php foreach ($Gallery as $GalleryData) { ?>
                      <tr>
                        ...
                        <td><?= $GalleryData['property']; ?> </td>
                        <td><?= $GalleryData['message']; ?> </td>
                        <td><?= date("d M, Y", strtotime($GalleryData['add_date'])); ?> </td>
                        <td>
                          <div class="btn-group">
                            <a class="btn btn-danger" href="<?= BASE_URL . 'admin/enquiry/Edelete/' . $GalleryData['id'] ?>"
