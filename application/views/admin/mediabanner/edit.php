...
<html lang="en">
     ...
     <?php $this->load->view("Element/admin/header.php");?>
      ...
      <section id="main-content">
          <section class="wrapper">            
			  ...
			  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-laptop"></i> Edit Banner Image</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="<?=BASE_URL?>admin/dashboard">Home</a></li>
						<li><i class="fa fa-laptop"></i> <a href="<?=BASE_URL?>admin/mediabanner">Media Banner</a></li>						  	
                  ...
                  <div class="col-lg-12">
                      ...
                      <section class="panel">
                          <header class="panel-heading">
                           EDIT BANNER IMAGE<br>
                           <a style="float:right;margin-bottom:10px;" class="btn btn-primary admin-buttns" href="<?=BASE_URL?>admin/mediabanner/" title="Back">Back</a>
  ...
  ?> 
                              <form class="form-horizontal" action="<?=BASE_URL.'admin/mediabanner/edit/'.$GalleryData[0]['id'];?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
								  ...
								  <div class="form-group">
                                        <div class="col-md-offset-4 col-md-4" >
                                              ...
                                              <button class="btn btn-default" onclick="window.location.href='<?=BASE_URL?>admin/mediabanner'" type="button">Cancel</button>
                                          </div>
                                      </div>
