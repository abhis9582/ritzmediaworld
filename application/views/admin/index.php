                  ...
                  <div class="col-lg-12">
                      <section class="panel">
						...
						<br>
							...
							<div class="col-md-2">		
								<a style="float:right;margin-bottom:10px;" class="btn btn-primary admin-buttns " href="<?=BASE_URL?>admin/howitworks/add" title="Add New Blog">Add How It Works </a>
                            </div>
						   ...
						   <?php if(count($Blogs) > 0) { ?>
                              ...
                              <tr>
                                 ...
                                 <td><?=substr($BlogsData['description'],0,80);?> </td>
								  <td><?php echo $blogCat =$this->howitworks_model->GetHowItworksCategoryNameByID($BlogsData['category_id']); ?> </td>
                                 ...
                                 <td>
                                  <div class="btn-group">
                                      <a class="btn btn-info" href="<?=BASE_URL.'admin/howitworks/edit/'.$BlogsData['id']?>" onclick="return confirm('Are You Sure to Edit ?');"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                      
                                      <a class="btn btn-danger" href="<?=BASE_URL.'admin/howitworks/delete/'.$BlogsData['id']?>" onclick="return confirm('Are You Sure to Delete ?');"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                                  </div>
                                  </td>
                              </tr>  
							  <?php } ?>							  
