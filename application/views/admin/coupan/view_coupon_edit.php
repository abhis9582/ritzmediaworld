...
<div id="content">
 <div class="breadcrumb_sitepanel"><?php echo anchor('sitepanel/dashbord','Home'); ?>&raquo; <?php echo anchor('sitepanel/coupons/','Back To Listing'); ?> &raquo;  <?php echo $heading_title; ?></div>
 <div class="box">
  <div class="heading">
   ...
   <div id="tab_pinfo">
    <table width="90%"  class="form"  cellpadding="3" cellspacing="3">
     ...
     <tr class="trOdd">
      ...
      <td width="72%" align="left"><input type="text" name="coupon_discount" size="40" value="<?php echo set_value('coupon_discount',$res->coupon_discount);?>"> [Ex : Percentage: 5, Amount: 120.00 ]</td>
     </tr>
     <tr class="trOdd">
      <td height="26" align="right" >Minimum order amount</td>
      <td align="left"><input type="text" name="minimum_order_amount" size="40" value="<?php echo set_value('minimum_order_amount',$res->minimum_order_amount);?>" /> [Ex : Amount: 1520.00 ] </td>
     </tr>
     <tr class="trOdd">
       <td height="26" align="right" >Coupon Usage</td>
       <td align="left">
        <input type="radio" name="coupon_usage" value="single" <?php if($res->coupon_usage == "single"){?> checked="checked" <?php }?> /> Single &nbsp;
        <input type="radio" name="coupon_usage" value="multiple" <?php if($res->coupon_usage == "multiple"){?> checked="checked" <?php }?> /> Multiple
       </td>
      </tr>
      <tr class="trOdd">
       <td width="28%" height="26" align="right" ><span class="required">*</span> Start Date:</td>
       <td width="72%" align="left"><input name="start_date" class="start_date1" type="text" style="padding:2px; width:133px;" value="<?php echo set_value('start_date',$res->start_date);?>"><a href="#" class="start_date"><img src="<?php echo base_url();?>assets/developers/images/cal0.png" width="16" height="16" alt=""></a></td>
      </tr>
      <tr class="trOdd">
       <td width="28%" height="26" align="right" ><span class="required">*</span> End Date:</td>
       <td width="72%" align="left"><input name="end_date" class="end_date1" type="text" style="padding:2px; width:133px;" value="<?php echo set_value('end_date',$res->end_date);?>"><a href="#" class="end_date"><img src="<?php echo base_url();?>assets/developers/images/cal0.png" width="16" height="16" alt=""></a></td>
      </tr>
      <tr class="trOdd">
       <td align="left">&nbsp;</td>
