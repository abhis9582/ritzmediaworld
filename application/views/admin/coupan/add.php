...
<html lang="en">
     ...
     <?php $this->load->view("Element/admin/header.php");?>
      ...
      <section id="main-content">
          <section class="wrapper">            
			  ...
			  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-laptop"></i> Add Coupan Code</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="<?=BASE_URL?>admin/dashboard">Home</a></li>
						<li><i class="fa fa-laptop"></i>Add New Coupan Code</li>						  	
					</ol>
				</div>
			</div>
  ...
  ?>
                              <form class="form-horizontal" action="<?=BASE_URL.'admin/coupan/add'?>" method="post" enctype="multipart/form-data">
							  <input id="SaveStatus" name="submitF" type="hidden" value="1" />
								...
								<div class="form-group">
                                      ...
                                      <div class="col-sm-6">
                                          <input type="text" class="form-control" name="coupon_code" value="<?php echo set_value('coupon_code',$GalleryData[0]['coupon_code']);?>"> 
                                      </div>
                                  </div>
