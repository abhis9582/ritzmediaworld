...
<html lang="en">
  ...
  ?> 
         <form class="form-horizontal" action="<?=BASE_URL.'admin/othercategories/add'?>" method="post">
							  <input id="SaveStatus" name="submitF" type="hidden" value="1" />
								  ...
								  <div class="form-group">
                                      ...
                                      <div class="col-sm-6">
                                          <input type="text" name="total_rooms" id="total_rooms" value="<?=(isset($_POST['total_rooms'])!='')?stripslashes($_POST['total_rooms']):''?>" class="form-control">
                                      </div>
                                  </div>
