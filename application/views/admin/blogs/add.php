     ...
     <?php $this->load->view("Element/admin/header.php");?>
      ...
      <section id="main-content">
       ...
       <a style="float:right;margin-bottom:10px;" class="btn btn-primary admin-buttns" href="<?=BASE_URL?>admin/blogs" title="Back">Back</a>
                ...
                ?>
                              <form class="form-horizontal" action="<?=BASE_URL.'admin/blogs/add'?>" method="post" enctype="multipart/form-data">
			...
			foreach($allblogs as $singleData){
				...
				if($_POST['category_id']==$singleData['id']){ $class= 'selected'; } else{  $class= '';  } ?>
		<option value="<?=$singleData['id'];?>" <?=$class;?>><?=$singleData['category_name'];?></option>
			<?php }  ?>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-6">
                                          <input type="text" name="title" id="title" value="<?=(isset($_POST['title'])!='')?$_POST['title']:''?>" class="form-control">
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label class="col-sm-2 control-label">Blog URL</label>
                                      <div class="col-sm-6">
                                          <input type="text" name="slug_url" id="slug_url" value="" class="form-control">
                                      </div>
                                  </div>
								   <div class="form-group">
                                      <label class="col-sm-2 control-label">Youtube Url</label>
                                      <div class="col-sm-6">
                                          <input type="text" name="youtube_video" id="title" value="<?=(isset($_POST['youtube_video'])!='')?$_POST['youtube_video']:''?>" class="form-control">
                                      </div>
                                  </div>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-2">
                                          <input type="number" name="y1_width" id="y1_width" class="form-control" min="0">
                                      </div>
                                      <label class="col-sm-2 control-label">Youtube Height</label>
                                      <div class="col-sm-2">
                                          <input type="number" name="y1_height" id="y1_height" class="form-control" min="0">
                                      </div>
                                  </div>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-6">
                                          <textarea name="description" id="description" value="" class="form-control ckeditor"><?=(isset($_POST['description'])!='')?stripslashes($_POST['description']):''?></textarea>
                                      </div>
                                  </div>
                                  <div id="new_chq"></div>
								...
								<div class="form-group">
                                    <div class="col-md-offset-4 col-md-4" >
                                        ...
                                        <button class="btn btn-default" onclick="window.location.href='<?=BASE_URL?>admin/blogs'"  type="button">Cancel</button>
                                    </div>
                                </div>
 ...
 <script>
  ...
  <!-- <script>
    ...
    //   var new_input='<input type="text" id="new_'+new_chq_no+"'>";
      var new_input='<div class="form-group new_details'+new_chq_no+'"><label class="col-sm-2 control-label">Blog Image '+new_chq_no+'</label><div class="col-sm-6"><input type="file" name="blog_image'+new_chq_no+'" id="blog_image'+new_chq_no+'" class="form-control"></div></div><div class="form-group new_details'+new_chq_no+'"><label class="col-sm-2 control-label">Blog Description '+new_chq_no+'</label><div class="col-sm-6"><textarea name="description'+new_chq_no+'" class="form-control ckeditor"></textarea></div></div>';
    ...
    function remove(){
      ...
      if(last_chq_no>1){
        $('.new_details'+last_chq_no).remove();
