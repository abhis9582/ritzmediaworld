...
<html lang="en">
			  ...
			  <div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						...
						<li><i class="fa fa-laptop"></i> <a href="<?=BASE_URL?>admin/testimonial">Edit Testimonial</a></li>						  	
  ...
  ?> 
                              <form class="form-horizontal" action="<?=BASE_URL.'admin/testimonial/edit/'.$GalleryData[0]['id'];?>" method="post" enctype="multipart/form-data">
							  ...
							  <input id="id" name="id" type="hidden" value="<?=$GalleryData[0]['id']?>" />
                                   ...
                                   <div class="form-group">
                                      ...
                                      <div class="col-sm-6">
                                          <input type="text" name="member_name" id="member_name" value="<?=(isset($GalleryData[0]['member_name'])!='')?$GalleryData[0]['member_name']:''?>" class="form-control">
                                      </div>
                                  </div>
								   ...
								   <div class="form-group">
                                      ...
                                      <div class="col-sm-6">
                                          <input type="text" name="position" id="position" value="<?=(isset($GalleryData[0]['position'])!='')?$GalleryData[0]['position']:''?>" class="form-control">
                                      </div>
                                  </div>
						...
						<div class="col-sm-6">
						<textarea name="description" id="description"  class="form-control"><?=(isset($GalleryData[0]['description'])!='')?$GalleryData[0]['description']:''?></textarea>
						</div>
						</div>
								  <div class="form-group">
                                      ...
                                      <div class="col-sm-6">
										  ...
										  <br> <span>Maximum Image Height:990 PX, Width: 890PX</span>
                                      </div>
                                  </div>
								    <div class="form-group">
								  ...
								  <div class="form-group">
                                        <div class="col-md-offset-4 col-md-4" >
                                              ...
                                              <button class="btn btn-default"   onclick="window.location.href='<?=BASE_URL?>admin/testimonial'" type="button">Cancel</button>
                                          </div>
                                      </div>
