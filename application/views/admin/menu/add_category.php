     ...
     <?php $this->load->view("Element/admin/header.php");?>
      ...
      <section id="main-content">
          <section class="wrapper">            
			  ...
			  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-laptop"></i> Add Menu Category</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="<?=BASE_URL?>admin/dashboard">Home</a></li>
						<li><i class="fa fa-laptop"></i>Add Menu Category</li>						  	
					</ol>
				</div>
			</div>
       ...
       <a style="float:right;margin-bottom:10px;" class="btn btn-primary admin-buttns" href="<?=BASE_URL?>admin/menu" title="Back">Back</a>
                ...
                ?>
                              <form class="form-horizontal" action="<?=BASE_URL.'admin/add_menu_category'?>" method="post" enctype="multipart/form-data">
