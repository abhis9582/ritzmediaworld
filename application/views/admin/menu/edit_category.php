            ...
            <div class="row">
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        ?> 
                <form class="form-horizontal" action="<?=BASE_URL.'admin/edit_menu_category/'.$category[0]['id'];?>" method="post" enctype="multipart/form-data">
                <input id="SaveStatus" name="submitF" type="hidden" value="1" />
                <input id="id" name="id" type="hidden" value="<?=$category[0]['id']?>" />
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Category Name</label>
                        <div class="col-sm-6">
                            <input type="text" name="category_name" id="category_name" value="<?php echo $category[0]['category_name'];?>" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            ...
                            $imgpath=$this->image->GetImageDirectory('menu',$imagename);
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6" >
                            <select name="status" class="form-control">
                                ...
                                <option value="0" <?php if($category[0]['status'] == '0'){echo "selected";} ?>>In-active</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-md-offset-4 col-md-4" >
                            ...
                            <button onclick="window.location.href='<?=BASE_URL?>admin/menu_category'" class="btn btn-default" type="button">Cancel</button>
                        </div>
                    </div>
                </form>
                </div>
