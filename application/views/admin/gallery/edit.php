...
<html lang="en">
     ...
     <?php $this->load->view("Element/admin/header.php");?>
      ...
      <section id="main-content">
          <section class="wrapper">            
			  ...
			  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-laptop"></i> Edit Image</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="<?=BASE_URL?>admin/dashboard">Home</a></li>
						<li><i class="fa fa-laptop"></i> <a href="<?=BASE_URL?>admin/gallery">Image</a></li>						  	
  ...
  ?> 
                              <form class="form-horizontal" action="<?=BASE_URL.'admin/gallery/edit/'.$GalleryData[0]['id'];?>" method="post" enctype="multipart/form-data">
								...
								?>
									 ...
									 <label class="col-sm-2 control-label">Category</label>
                                      <div class="col-sm-6">
										  ...
										  <option value="1000" <?=('1000'==$GalleryData[0]['category_id'])?'selected':''?>>Home Page Middle Image</option>
										  <option value="1001" <?=('1001'==$GalleryData[0]['category_id'])?'selected':''?>>Brand Image</option>
										  <option value="1002" <?=('1002'==$GalleryData[0]['category_id'])?'selected':''?>>What We Offer</option>
										  <option value="1003" <?=('1003'==$GalleryData[0]['category_id'])?'selected':''?>>Wedding Page</option>
										  <option value="1003" <?=('1004'==$GalleryData[0]['category_id'])?'selected':''?>>Event Page</option>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <?=(isset($GalleryData[0]['description'])!='')?trim($GalleryData[0]['description']):''?>
                                      </textarea>
