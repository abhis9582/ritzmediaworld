...
?> 
  ...
  <div class="col-lg-6">
			...
			<form method="post" action="<?=BASE_URL.'admin/listing/add_hotel_price/'.$listing_id.'/'.$category_id?>" class="form-horizontal" role="form" enctype="multipart/form-data">
			...
			<div class="col-md-9">
			<input type="text" class="form-control datepicker" name="room_date" value="<?=(isset($_POST['room_date'])!='')?$_POST['room_date']:''?>" placeholder="Room Date">
			</div>
			</div>
			...
			<div class="col-md-9">
			<input type="text" class="form-control" name="price" value="<?=(isset($_POST['price'])!='')?$_POST['price']:''?>" placeholder="Price">
			</div>
			</div>
			<div class="form-group">
