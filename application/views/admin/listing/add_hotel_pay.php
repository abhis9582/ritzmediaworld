     ...
     <?php $this->load->view("Element/admin/header.php");?>
      ...
      <section id="main-content">
          <section class="wrapper">            
			  ...
			  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-laptop"></i> Hotel Pay</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="<?=BASE_URL?>admin/dashboard">Home</a></li>
						<li><i class="fa fa-laptop"></i><a href="<?=BASE_URL?>admin/listing/listing_hotel_pay"> Hotel Pay</a></li>
                        <li><i class="fa fa-laptop"></i> Add Pay</li>						
          ...
          <div class="row">
                  <div class="col-lg-12">
                      <section class="panel">
                       ...
                       Add Hotel Pay
							<br>
							<a style="float:right;margin-bottom:10px;" class="btn btn-primary admin-buttns" href="<?=BASE_URL?>admin/listing/listing_hotel_pay" title="Back">Back</a>
                          </header>
...
?> 
  ...
  <div class="col-lg-6">
			...
			<form method="post" action="<?=BASE_URL.'admin/listing/add_hotel_pay/'.$listing_id?>" class="form-horizontal" role="form" enctype="multipart/form-data">
			...
			<div class="col-md-9">
			<input class="form-control datepicker"  autocomplete="off"   value="<?=(isset($_POST['start_date'])!='')?$_POST['start_date']:''?>" name="start_date" value="" placeholder="Start Date">
			</div>
			</div>
			...
			<div class="col-md-9">
			<input class="form-control datepicker"  autocomplete="off"  value="<?=(isset($_POST['end_date'])!='')?$_POST['end_date']:''?>" name="end_date" value="" placeholder="End Date">
			</div>
			</div>	
