...
<html lang="en">
  <head>
    ...
    <title>Bulk Inventory Upate</title>
     ...
     <?php $this->load->view("Element/admin/header.php");?>
      ...
      <section id="main-content">
          <section class="wrapper">            
			  ...
			  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-laptop"></i> Bulk Inventory Update</h3>
					<ol class="breadcrumb">
          ...
          <div class="row">
                  <div class="col-lg-12">
                      <section class="panel">
                         ...
                         Bulk Inventory Update (Hotel - <?=$listing[0]['listing_title']?>)
						<br>
...
?> 
						 <form method="post" class="form-horizontal" action="<?=BASE_URL?>admin/listing/bulk_inventory_update/<?=$listing[0]['id']?>">
                 ...
                 <div class="col-md-12 ravi_margin">
						...
						<div class="col-md-12">
						   <div class="form-group">
                  <label for="icode" class="col-md-12 ravi_margin">Price SGL</label>
                 <div class="col-md-12 ravi_margin">
						<input type="text" name="price_sgl" class="form-control">
						</div>
						</div>
						</div>
						...
						<div class="col-md-12">
						   <div class="form-group">
                  <label for="icode" class="col-md-12 ravi_margin">Price DBL</label>
                 <div class="col-md-12 ravi_margin">
						<input type="text" name="price_dbl" class="form-control">
						</div>
						</div>
						</div>
