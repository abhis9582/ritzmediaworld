    ...
    <section id="main-content">
      <section class="wrapper">            
        <!--overview start-->
			  <div class="row">
  				<div class="col-lg-12">
  					<h3 class="page-header"><i class="fa fa-laptop"></i> Edit Wedding</h3>
  					<ol class="breadcrumb">
  						<li><i class="fa fa-home"></i><a href="<?=BASE_URL?>admin/dashboard">Home</a></li>
  						<li><i class="fa fa-laptop"></i> <a href="<?=BASE_URL?>admin/wedding">Wedding</a></li>						  	
                    ...
                    <div class="form-group">  
                      ...
                      <div class="col-sm-12">
                        ...
                        <input type="file" name="page_image1" id="page_image1" class="form-control">
  										  <?php $src = $this->image->getImageSrc("pages",$WeddingData[0]['page_image1'],""); ?>
