    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-9">
                ...
                <h3 class="right_heading">CHANGE PASSWORD</h3>
                <?php
        		...
        		?> 
        		<form method="post" action="<?=BASE_URL.'user/changepassword'?>" class="form-horizontal" role="form" enctype="multipart/form-data">
					<input id="SaveStatus" name="submitF" type="hidden" value="1" />
				      ...
				      <table>
				          ...
				          <tr>
				              <td><button class="btn btn-primary" name="submitForm" type="submit">Update</button></td>
				          </tr>
				      </table> 
                  </form>
                </div>
