...
echo form_open(BASE_URL.'forgotpassword',array('class'=>'form-horizontal'));
...
<?=$this->session->flashdata("success")?></div><?php } ?>
     ...
     <table id="loginbox">
         <tr>
             <td><input id="login-username" type="text" class="form-control" name="email_id" value="" placeholder="Email Id"></td>
         </tr>
         <tr>
             <td><button id="btn-login" type="submit" class="btn btn-lg btn-success btn-block btn-signin">Submit</button></td>
         </tr>
         <tr>
             <td><a  href="<?=BASE_URL?>login">Login</a></td>
         </tr> 
     </table>
